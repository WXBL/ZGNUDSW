...
typedef void (^getUserRegistCompletionHandler)(NSString *result);
typedef void (^getUserRegistErrorHandler)(NSString * error);
typedef void (^getUserLoginCompletionHandler)(WXUserModel * result);
typedef void (^getUserLoginErrorHandler)(NSString *error);
typedef void (^updateUserPasswordCompletionHandler)(NSString *result);
typedef void (^updateUserPasswordErrorHandler)(NSString *error);
typedef void (^updateUserInformationCompletionHandler)(WXUserModel *result);
typedef void (^updateUserInformationErrorHandler)(NSString *error);
typedef void (^vertifyUserNameIsExitCompletionHandler)(NSString *result);
typedef void (^vertifyUserNameIsExitErrorHandler)(NSString *error);
@interface WXUserService : WXBaseService
